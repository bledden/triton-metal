...
@triton.jit
def _gather2d_axis0(src_ptr, idx_ptr, out_ptr, Ms: tl.constexpr, Mi: tl.constexpr, N: tl.constexpr):
...
@triton.jit
def _gather2d_axis1(src_ptr, idx_ptr, out_ptr, M: tl.constexpr, N: tl.constexpr):
